...
public static class SetsAndMaps
{
    ...
    public static bool IsAnagram(string word1, string word2)
    {
        ...
        foreach (var character in word1)
        {
            ...
            if (characterCounts.ContainsKey(normalized))
            {
                characterCounts[normalized]++;
            }
            else
            {
                characterCounts[normalized] = 1;
            }
        }
        ...
        foreach (var character in word2)
        {
            ...
            characterCounts[normalized]--;
            if (characterCounts[normalized] == 0)
            {
                characterCounts.Remove(normalized);
            }
        }

        return characterCounts.Count == 0;
    }
    ...
    public static string[] EarthquakeDailySummary()
    {
        ...
        foreach (var feature in featureCollection.Features)
        {
            ...
            var place = string.IsNullOrWhiteSpace(feature.Properties.Place)
                ? "Unknown location"
